...
#                                                                             
# PROGRAMMER: CHARLES AKINNURUN
# DATE CREATED: 28TH OF AUGUST 2026                                  
# REVISED DATE: 
...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic["pct_match"] = (
        n_match / n_images * 100.0 if n_images else 0.0
    )
    results_stats_dic["pct_correct_dogs"] = (
        n_correct_dogs / n_dogs_img * 100.0 if n_dogs_img else 0.0
    )
    results_stats_dic["pct_correct_breed"] = (
        n_correct_breed / n_dogs_img * 100.0 if n_dogs_img else 0.0
    )
    results_stats_dic["pct_correct_notdogs"] = (
        n_correct_notdogs / n_notdogs_img * 100.0 if n_notdogs_img else 0.0
    )
